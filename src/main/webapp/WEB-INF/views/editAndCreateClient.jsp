    ...
    <jsp:body>
        <div class="container form-client">
            <form id="formClient" action="/client/edit" method="post" class="form-horizontal">
                <div id="formCaption">
                    <h3>Форма добавления(редактирования) клиентов</h3>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="surname" name="surname" placeholder="Фамилия"
                               required="required" pattern="[а-яА-ЯёЁa-zA-Z0-9]{1,20}" value="${client.surname}">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" id="name" name="name" placeholder="Имя"
                               required="required" pattern="[а-яА-ЯёЁa-zA-Z0-9]{1,20}" value="${client.name}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" id="patronymic" name="patronymic" placeholder="Отчество"
                               required="required" pattern="[а-яА-ЯёЁa-zA-Z0-9]{1,20}" value="${client.patronymic}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input id="monthly_income" class="form-control-range" type="range"
                               min="0" max="2000" step="100" value="${client.monthly_income}"/>
                        <div>value: <span id="textShowValueMonthlyIncome"></span></div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" id="bpl" name="bpl" placeholder="Место рождения"
                               required="required" value="${client.bpl}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" id="passport_series" name="passport_series"
                               placeholder="Серия паспорта" required="required" pattern="[а-яА-ЯёЁa-zA-Z0-9]{1,20}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" id="passport_authority" name="passport_authority"
                               placeholder="Кем выдан" required="required" value="${client.passport.passport_authority}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" id="address" name="address" placeholder="Адрес"
                               required="required" value="${client.contact.address}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <button type="submit" name="submit"
                                class="btn btn-success btn-client">Добавить\Редактировать клиента</button>
                    </div>
                </div>
            </form>
        </div>
